...
static const char *const msgOptionNames[] = {"rc", "error", "rows", "peo", "ocicode", "sqltype", "fn", "action", "sqlstate", "recoverable", "warning", "offset", "all", "allx", NULL};
enum MsgOptionIdx { MSG_RC, MSG_ERROR, MSG_ROWS, MSG_PEO, MSG_OCICODE, MSG_SQLTYPE, MSG_FN, MSG_ACTION, MSG_SQLSTATE, MSG_RECOVERABLE, MSG_WARNING, MSG_OFFSET, MSG_ALL, MSG_ALLX };
