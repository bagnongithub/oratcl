 ...
 *
 * Worker thread contract — NO Tcl_Interp API in worker threads
 *
 ...
 *
 * Design note — Tcl_GetWideIntFromObj vs Tcl_GetSizeIntFromObj
 *
...
/* Finite timeout (ms) for teardown waits.  30 seconds gives the
...
/* centralized checked list-append macro.  Every call to
...
/* Cleanup-compatible variant — jumps to a label instead of
...
/* clear helpers for the embedded maps in OradpiInterpState */
